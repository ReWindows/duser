...
|---|---|---|---|---|
| `OnManipulationCompleted` | `void` | `Method` | `Pdb` | No (PDB) |
...
| `CInertiaProcessorCore` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `CalculateCollision` | `void` | `Method` | `Pdb` | No (PDB) |
| `CalculateCollision` | `void` | `Method` | `Pdb` | No (PDB) |
| `CalculateTime` | `double` | `Method` | `Pdb` | No (PDB) |
| `CleanReset` | `void` | `Method` | `Pdb` | No (PDB) |
| `ExtrapolateAndRaiseEvents` | `bool` | `Method` | `Pdb` | No (PDB) |
| `GetDuration` | `double` | `Accessor` | `Pdb` | No (PDB) |
| `GetEndPosition` | `double` | `Accessor` | `Pdb` | No (PDB) |
| `GetExtrapolatedValueAndUpdateState` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `GetPosition` | `double` | `Accessor` | `Pdb` | No (PDB) |
| `GetRecommendedAbsoluteCollisionVelocity` | `double` | `Accessor` | `Pdb` | No (PDB) |
| `GetTimeToPosition` | `double` | `Accessor` | `Pdb` | No (PDB) |
| `GetVelocity` | `double` | `Accessor` | `Pdb` | No (PDB) |
| `Prepare` | `void` | `Method` | `Pdb` | No (PDB) |
| `Prepare` | `void` | `Method` | `Pdb` | No (PDB) |
| `Process` | `bool` | `Method` | `Pdb` | No (PDB) |
| `Reset` | `void` | `Method` | `Pdb` | No (PDB) |
| `RevertCollision` | `void` | `Method` | `Pdb` | No (PDB) |
| `RevertCollision` | `void` | `Method` | `Pdb` | No (PDB) |
| `SetDesiredAngularDeceleration` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `SetDesiredDeceleration` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `SetDesiredDisplacement` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `SetDesiredExpansion` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `SetDesiredExpansionDeceleration` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `SetDesiredRotation` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `SetInitialAngularVelocity` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `SetInitialExpansionVelocity` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `SetInitialOriginX` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `SetInitialOriginY` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `SetInitialRadius` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `SetInitialVelocityX` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `SetInitialVelocityY` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `TryCalculateCollisionTime` | `bool` | `Method` | `Pdb` | No (PDB) |
