# `global` :: `CInteractionEngineImpl`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `duser.dll`. Total members: **21**.
...
|---|---|---|---|---|
| `_EnsureEngineCreated` | `long` | `Method` | `Pdb` | No (PDB) |
| `CInteractionEngineImpl` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~CInteractionEngineImpl` | `void` | `Dtor` | `Pdb` | No (PDB) |
| ``vector deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| ``scalar deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| `DigitizerInput` | `long` | `Method` | `Pdb` | No (PDB) |
| `FrameValidation` | `long` | `Method` | `Pdb` | No (PDB) |
| `GetState` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `InInertia` | `long` | `Method` | `Pdb` | No (PDB) |
| `OnContactTransition` | `long` | `Method` | `Pdb` | No (PDB) |
| `OnResetTime` | `long` | `Method` | `Pdb` | No (PDB) |
| `SetConfiguration` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `SetExternalParameters` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `SetParameters` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `SetPrivateParameter` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `_SetBufferedConfiguration` | `void` | `Method` | `Pdb` | No (PDB) |
| `_SetBufferedParameters` | `void` | `Method` | `Pdb` | No (PDB) |
| `_SetExternalParameters` | `void` | `Method` | `Pdb` | No (PDB) |
| `_SetPublicParameters` | `long` | `Method` | `Pdb` | No (PDB) |
| `_StopInputInternal` | `long` | `Method` | `Pdb` | No (PDB) |
| `_StopPreviousInertia` | `long` | `Method` | `Pdb` | No (PDB) |
