...
|---|---|---|---|---|
| `~BufferManager` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `BufferManager` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `Destroy` | `void` | `Method` | `Pdb` | No (PDB) |
| `RemoveAllTrxBuffers` | `void` | `Method` | `Pdb` | No (PDB) |
| `ReleaseCachedBuffer` | `void` | `Method` | `Pdb` | No (PDB) |
