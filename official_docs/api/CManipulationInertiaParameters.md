# `global` :: `CManipulationInertiaParameters`
...
|---|---|---|---|---|
| `CManipulationInertiaParameters` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `GetDefaultDeceleration` | `float` | `Accessor` | `Pdb` | No (PDB) |
| `InertiaSetupCallback` | `void` | `Method` | `Pdb` | No (PDB) |
