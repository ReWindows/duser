...
Reconstructed from `duser.dll`. Total members: **26**.
...
|---|---|---|---|---|
| `CheckDCompDeviceAndResources` | `long` | `Method` | `Pdb` | No (PDB) |
| ``vector deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| ``scalar deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| `~HWndContainer` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `xdHandleMessage` | `int` | `Method` | `Pdb` | No (PDB) |
| `GetRootVisual` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `Build` | `long` | `Method` | `Pdb` | No (PDB) |
| `HWndContainer` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `SyncCursorSuppressed` | `void` | `Method` | `Pdb` | No (PDB) |
| `OnRescanMouseEx` | `int` | `Method` | `Pdb` | No (PDB) |
| `IsCursorSuppressed` | `bool` | `Accessor` | `Pdb` | No (PDB) |
| `OnInvalidate` | `void` | `Method` | `Pdb` | No (PDB) |
| `OnGetRect` | `void` | `Method` | `Pdb` | No (PDB) |
| `OnSetFocus` | `void` | `Method` | `Pdb` | No (PDB) |
| `OnTrackMouseLeave` | `int` | `Method` | `Pdb` | No (PDB) |
| `ScheduleTransitionVisualPaintAndCommit` | `void` | `Method` | `Pdb` | No (PDB) |
| `OnRescanMouse` | `void` | `Method` | `Pdb` | No (PDB) |
| `OnStartCapture` | `void` | `Method` | `Pdb` | No (PDB) |
| `OnEndCapture` | `void` | `Method` | `Pdb` | No (PDB) |
| `HandleTouchInteraction` | `void` | `Method` | `Pdb` | No (PDB) |
| `GetHandleType` | `enum HandleType` | `Accessor` | `Pdb` | No (PDB) |
| `BroadcastDCompDeviceRebuilt` | `void` | `Method` | `Pdb` | No (PDB) |
| `DrawGadgetExternal` | `long` | `Method` | `Pdb` | No (PDB) |
| `NotifyCompositionChanged` | `long` | `Method` | `Pdb` | No (PDB) |
| `ResetDevice` | `long` | `Method` | `Pdb` | No (PDB) |
| `TouchInteractionCallback` | `void` | `Method` | `Pdb` | No (PDB) |
