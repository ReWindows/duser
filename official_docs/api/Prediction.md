...
Reconstructed from `duser.dll`. Total members: **12**.
...
public:
    class CFixPred;
    class tagExpoSmoother;
    class tagMedianSmoother;
    class tagRlsFilter;
public /*unspecified*/:
    // Category: Method | Source: PDB Internal
    // Symbol: ?DeltaOvershootCompensation@Prediction@@YA_J_J0@Z
    int64_t DeltaOvershootCompensation(int64_t, int64_t);
};
...
|---|---|---|---|---|
| `operator*<class Prediction::CFixPred, 3>` | `class Prediction::SquareMatrix<class Prediction::CFixPred, 3>` | `Operator` | `Pdb` | No (PDB) |
| `operator*<class Prediction::CFixPred, 3>` | `class Prediction::Vector<class Prediction::CFixPred, 3>` | `Operator` | `Pdb` | No (PDB) |
| `operator*<class Prediction::CFixPred, 3>` | `class Prediction::Vector<class Prediction::CFixPred, 3>` | `Operator` | `Pdb` | No (PDB) |
| `operator*<class Prediction::CFixPred, 3>` | `class Prediction::SquareMatrix<class Prediction::CFixPred, 3>` | `Operator` | `Pdb` | No (PDB) |
| `operator^<class Prediction::CFixPred, 3>` | `class Prediction::SquareMatrix<class Prediction::CFixPred, 3>` | `Operator` | `Pdb` | No (PDB) |
| `operator*<class Prediction::CFixPred, 3>` | `class Prediction::CFixPred` | `Operator` | `Pdb` | No (PDB) |
| `operator*` | `class Prediction::CFixPred` | `Operator` | `Pdb` | No (PDB) |
| `operator+<class Prediction::CFixPred, 3>` | `class Prediction::Vector<class Prediction::CFixPred, 3>` | `Operator` | `Pdb` | No (PDB) |
| `operator-<class Prediction::CFixPred, 3>` | `class Prediction::SquareMatrix<class Prediction::CFixPred, 3>` | `Operator` | `Pdb` | No (PDB) |
| `Tri<class Prediction::CFixPred, 3>` | `class Prediction::SquareMatrix<class Prediction::CFixPred, 3>` | `Method` | `Pdb` | No (PDB) |
| `operator/` | `class Prediction::CFixPred` | `Operator` | `Pdb` | No (PDB) |
| `DeltaOvershootCompensation` | `int64_t` | `Method` | `Pdb` | No (PDB) |
