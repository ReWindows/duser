...
|---|---|---|---|---|
| `CTouchMachineWithUI` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `DismissPHFeedback` | `void` | `Method` | `Pdb` | No (PDB) |
| `OnCursorDown` | `long` | `Method` | `Pdb` | No (PDB) |
| `OnCursorUp` | `long` | `Method` | `Pdb` | No (PDB) |
| `OnPacket` | `long` | `Method` | `Pdb` | No (PDB) |
