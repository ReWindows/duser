...
|---|---|---|---|---|
| `Lookup` | `long` | `Method` | `Pdb` | No (PDB) |
| `Remove` | `long` | `Method` | `Pdb` | No (PDB) |
| `Add` | `long` | `Method` | `Pdb` | No (PDB) |
| `Expand` | `long` | `Method` | `Pdb` | No (PDB) |
| `DuTicketManager` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~DuTicketManager` | `void` | `Dtor` | `Pdb` | No (PDB) |
