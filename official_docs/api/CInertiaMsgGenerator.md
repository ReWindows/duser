...
|---|---|---|---|---|
| `CInertiaMsgGenerator` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~CInertiaMsgGenerator` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `AdjustPointWithDisplacement` | `int` | `Method` | `Pdb` | No (PDB) |
| `EnsureInertiaProcessor` | `int` | `Method` | `Pdb` | No (PDB) |
| `EnsureInertiaProcessorUnit` | `int` | `Method` | `Pdb` | No (PDB) |
| `FinishGestureStream` | `void` | `Method` | `Pdb` | No (PDB) |
| `GetInertiaData` | `int` | `Accessor` | `Pdb` | No (PDB) |
| `GetInertiaEnd` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `IsInertiaPossible` | `int` | `Accessor` | `Pdb` | No (PDB) |
| `OnTimer` | `void` | `Method` | `Pdb` | No (PDB) |
| `SetInertiaParameter` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `StartInertia` | `int` | `Method` | `Pdb` | No (PDB) |
| `StartInertiaForManipulation` | `int` | `Method` | `Pdb` | No (PDB) |
| `StopInertia` | `void` | `Method` | `Pdb` | No (PDB) |
