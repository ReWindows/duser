# `global` :: `CSysEventConverter`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `duser.dll`. Total members: **23**.
...
|---|---|---|---|---|
| `_StopCurrentInteraction` | `long` | `Method` | `Pdb` | No (PDB) |
| `_OnHoldLeave` | `long` | `Method` | `Pdb` | No (PDB) |
| `Process` | `long` | `Method` | `Pdb` | No (PDB) |
| `Stop` | `long` | `Method` | `Pdb` | No (PDB) |
| `_AddOutput` | `long` | `Method` | `Pdb` | No (PDB) |
| `_GlobalBegin` | `long` | `Method` | `Pdb` | No (PDB) |
| `_GlobalEnd` | `long` | `Method` | `Pdb` | No (PDB) |
| `_OnDownBegin` | `long` | `Method` | `Pdb` | No (PDB) |
| `_OnDownEnd` | `long` | `Method` | `Pdb` | No (PDB) |
| `_OnDragBegin` | `long` | `Method` | `Pdb` | No (PDB) |
| `_OnDragBeginEnd` | `long` | `Method` | `Pdb` | No (PDB) |
| `_OnDragEnd` | `long` | `Method` | `Pdb` | No (PDB) |
| `_OnDragMove` | `long` | `Method` | `Pdb` | No (PDB) |
| `_OnFlick` | `long` | `Method` | `Pdb` | No (PDB) |
| `_OnHoldAnimationBegin` | `long` | `Method` | `Pdb` | No (PDB) |
| `_OnHoldAnimationEnd` | `long` | `Method` | `Pdb` | No (PDB) |
| `_OnHoldEnter` | `long` | `Method` | `Pdb` | No (PDB) |
| `_OnHoverEnter` | `long` | `Method` | `Pdb` | No (PDB) |
| `_OnHoverLeave` | `long` | `Method` | `Pdb` | No (PDB) |
| `_OnInAirEnter` | `long` | `Method` | `Pdb` | No (PDB) |
| `_OnInAirLeave` | `long` | `Method` | `Pdb` | No (PDB) |
| `_OnInAirMove` | `long` | `Method` | `Pdb` | No (PDB) |
| `_OnTap` | `long` | `Method` | `Pdb` | No (PDB) |
