...
|---|---|---|---|---|
| `OnDown` | `long` | `Method` | `Pdb` | No (PDB) |
| `OnMove` | `long` | `Method` | `Pdb` | No (PDB) |
| `OnUp` | `long` | `Method` | `Pdb` | No (PDB) |
| `SetStrokeConfiguration` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `_IsDrag` | `int` | `Method` | `Pdb` | No (PDB) |
| `_SetState` | `void` | `Method` | `Pdb` | No (PDB) |
