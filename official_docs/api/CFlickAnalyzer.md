# `global` :: `CFlickAnalyzer`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `duser.dll`. Total members: **14**.
...
|---|---|---|---|---|
| `CFlickAnalyzer` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `AddPoint` | `void` | `Method` | `Pdb` | No (PDB) |
| `Analyze` | `void` | `Method` | `Pdb` | No (PDB) |
| `CheckWithThreshhold` | `void` | `Method` | `Pdb` | No (PDB) |
| `GetPhysicalCoordinates` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `InitializeTablet` | `long` | `Method` | `Pdb` | No (PDB) |
| `OnCursorDown` | `void` | `Method` | `Pdb` | No (PDB) |
| `OnCursorUp` | `void` | `Method` | `Pdb` | No (PDB) |
| `OnPacket` | `void` | `Method` | `Pdb` | No (PDB) |
| `ProcessPacket` | `void` | `Method` | `Pdb` | No (PDB) |
| `ResetMachine` | `void` | `Method` | `Pdb` | No (PDB) |
| `SetStableRect` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `SetToleranceCore` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `UpdateTimePeriod` | `void` | `Method` | `Pdb` | No (PDB) |
