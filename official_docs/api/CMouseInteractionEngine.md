# `global` :: `CMouseInteractionEngine`
...
| `GetWheelImplementor` | `class IWheelImplementor *` | `Accessor` | `Pdb` | No (PDB) |
| `IsManipulationInertiaSupported` | `bool` | `Accessor` | `Pdb` | No (PDB) |
| `~CMouseInteractionEngine` | `void` | `Dtor` | `Pdb` | No (PDB) |
...
| `GetWheelInertiaParameter` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `GetWheelParameter` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `InInertia` | `long` | `Method` | `Pdb` | No (PDB) |
| `Initialize` | `long` | `Method` | `Pdb` | No (PDB) |
| `IsPartiallyConstructed` | `bool` | `Accessor` | `Pdb` | No (PDB) |
...
| `OnWheel` | `long` | `Method` | `Pdb` | No (PDB) |
