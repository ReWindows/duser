...
| `CInertiaProcessorUnit` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~CInertiaProcessorUnit` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `GetEffectiveAcceleration` | `void` | `Accessor` | `Pdb` | No (PDB) |
...
| `SetInitialTime` | `int` | `Accessor` | `Pdb` | No (PDB) |
| `Start` | `int` | `Method` | `Pdb` | No (PDB) |
| `Stop` | `void` | `Method` | `Pdb` | No (PDB) |
| `Timer` | `int` | `Method` | `Pdb` | No (PDB) |
| `_EnsureInertiaProcessorForUnit` | `int` | `Method` | `Pdb` | No (PDB) |
| `_InputTimeFromTimerTime` | `unsigned int` | `Method` | `Pdb` | No (PDB) |
