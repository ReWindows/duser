...
|---|---|---|---|---|
| `xdFireSyncAdaptor` | `void` | `Method` | `Pdb` | No (PDB) |
| `xdFireChangeState` | `void` | `Method` | `Pdb` | No (PDB) |
| `xwInvokeDirect` | `long` | `Method` | `Pdb` | No (PDB) |
| `xdFireChangeStyle` | `void` | `Method` | `Pdb` | No (PDB) |
| `xwInvokeFull` | `long` | `Method` | `Pdb` | No (PDB) |
| `xwCallOnEvent` | `long` | `Method` | `Pdb` | No (PDB) |
| `xdFireMouseMessage` | `void` | `Method` | `Pdb` | No (PDB) |
| `xwFireDestroy` | `void` | `Method` | `Pdb` | No (PDB) |
| `Create` | `void` | `Method` | `Pdb` | No (PDB) |
| `xrFireQueryHitTest` | `void` | `Method` | `Pdb` | No (PDB) |
| `xrFirePaint` | `void` | `Method` | `Pdb` | No (PDB) |
