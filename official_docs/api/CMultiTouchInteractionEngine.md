# `global` :: `CMultiTouchInteractionEngine`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `duser.dll`. Total members: **38**.
...
| `CMultiTouchInteractionEngine` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `GetCrossSlideImplementor` | `class ICrossSlideImplementor *` | `Accessor` | `Pdb` | No (PDB) |
| `IsManipulationInertiaSupported` | `bool` | `Accessor` | `Pdb` | No (PDB) |
| `~CMultiTouchInteractionEngine` | `void` | `Dtor` | `Pdb` | No (PDB) |
...
| `GetCrossSlideParameters` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `GetHoldImplementor` | `class IHoldImplementor *` | `Accessor` | `Pdb` | No (PDB) |
| `GetInertiaEnd` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `GetPredictionImplementor` | `class IPredictionImplementor *` | `Accessor` | `Pdb` | No (PDB) |
...
| `GetTranslationImplementor` | `class ITranslationImplementor *` | `Accessor` | `Pdb` | No (PDB) |
...
| `OutputPrediction` | `long` | `Method` | `Pdb` | No (PDB) |
