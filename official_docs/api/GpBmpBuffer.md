...
|---|---|---|---|---|
| `GetType` | `enum DuSurface::EType` | `Accessor` | `Pdb` | No (PDB) |
| `~GpBmpBuffer` | `void` | `Dtor` | `Pdb` | No (PDB) |
| ``vector deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| ``scalar deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| `AllocBitmap` | `int` | `Method` | `Pdb` | No (PDB) |
| `BeginDraw` | `long` | `Method` | `Pdb` | No (PDB) |
| `EndDraw` | `void` | `Method` | `Pdb` | No (PDB) |
| `Fill` | `void` | `Method` | `Pdb` | No (PDB) |
| `FreeBitmap` | `void` | `Method` | `Pdb` | No (PDB) |
| `InUse` | `int` | `Method` | `Pdb` | No (PDB) |
| `PostEndDraw` | `void` | `Method` | `Pdb` | No (PDB) |
| `PreEndDraw` | `void` | `Method` | `Pdb` | No (PDB) |
| `SetupClipRgn` | `void` | `Method` | `Pdb` | No (PDB) |
