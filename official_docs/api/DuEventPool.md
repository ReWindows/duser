...
|---|---|---|---|---|
| `AddHandler` | `enum DuEventPool::EAdd` | `Method` | `Pdb` | No (PDB) |
| `FindItem` | `int` | `Method` | `Pdb` | No (PDB) |
| `RegisterMessage` | `long` | `Method` | `Pdb` | No (PDB) |
| `RemoveHandler` | `long` | `Method` | `Pdb` | No (PDB) |
| `RemoveHandler` | `long` | `Method` | `Pdb` | No (PDB) |
| `FindItem` | `int` | `Method` | `Pdb` | No (PDB) |
