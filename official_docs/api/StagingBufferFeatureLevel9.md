# `global` :: `StagingBufferFeatureLevel9`
...
|---|---|---|---|---|
| `~StagingBufferFeatureLevel9` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `StagingBufferFeatureLevel9` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `SetDevice` | `void` | `Accessor` | `Pdb` | No (PDB) |
| ``vector deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| ``scalar deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| `CopyInternal` | `void` | `Method` | `Pdb` | No (PDB) |
| `CreateSurfaceInternal` | `long` | `Method` | `Pdb` | No (PDB) |
| `DestroySurfaceInternal` | `void` | `Method` | `Pdb` | No (PDB) |
| `IsSurfaceAllocated` | `int` | `Accessor` | `Pdb` | No (PDB) |
| `MapInternal` | `long` | `Method` | `Pdb` | No (PDB) |
| `UnmapInternal` | `void` | `Method` | `Pdb` | No (PDB) |
