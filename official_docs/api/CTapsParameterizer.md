# `global` :: `CTapsParameterizer`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `duser.dll`. Total members: **4**.
...
|---|---|---|---|---|
| `InitializeTouch` | `void` | `Method` | `Pdb` | No (PDB) |
| `InitializePen` | `void` | `Method` | `Pdb` | No (PDB) |
| `SetTouchDoubleTapDistanceFromRegistry` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `SetTouchDoubleTapTimeFromRegistry` | `long` | `Accessor` | `Pdb` | No (PDB) |
