# `global` :: `CManipulationProcessorUnit`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `duser.dll`. Total members: **17**.
...
|---|---|---|---|---|
| `SetConfiguration` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `ResetState` | `void` | `Method` | `Pdb` | No (PDB) |
| ``scalar deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| `CManipulationProcessorUnit` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `OnContactMove` | `int` | `Method` | `Pdb` | No (PDB) |
| `GetInManipulationState` | `int` | `Accessor` | `Pdb` | No (PDB) |
| `SetProcessedTransform` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `SetRailingStrength` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `~CManipulationProcessorUnit` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `GetRadius` | `float` | `Accessor` | `Pdb` | No (PDB) |
| `IsResultUpdated` | `int` | `Accessor` | `Pdb` | No (PDB) |
| `OnContactDown` | `int` | `Method` | `Pdb` | No (PDB) |
| `OnContactUp` | `int` | `Method` | `Pdb` | No (PDB) |
| `OnStop` | `int` | `Method` | `Pdb` | No (PDB) |
| `PostProcessResult` | `void` | `Method` | `Pdb` | No (PDB) |
| `SetPivot` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `SetResult` | `void` | `Accessor` | `Pdb` | No (PDB) |
