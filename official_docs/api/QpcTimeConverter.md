...
|---|---|---|---|---|
| `QpcToMicroSec` | `int` | `Method` | `Pdb` | No (PDB) |
| `QpcTimeConverter` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `GetCurrentMilliSecTime` | `unsigned int` | `Accessor` | `Pdb` | No (PDB) |
