...
|---|---|---|---|---|
| `CPenLogic` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~CPenLogic` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `EnsureFlicksMachine` | `long` | `Method` | `Pdb` | No (PDB) |
| `EnsureTapsMachine` | `long` | `Method` | `Pdb` | No (PDB) |
| `GetResult` | `int` | `Accessor` | `Pdb` | No (PDB) |
| `HandleFlickAtCursorUp` | `void` | `Method` | `Pdb` | No (PDB) |
| `IsFlickAllowed` | `int` | `Accessor` | `Pdb` | No (PDB) |
...
| `ResetHoverState` | `void` | `Method` | `Pdb` | No (PDB) |
| `ResetInAirState` | `void` | `Method` | `Pdb` | No (PDB) |
| `ResetState` | `void` | `Method` | `Pdb` | No (PDB) |
| `SetResult` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `UpdateHoverState` | `void` | `Method` | `Pdb` | No (PDB) |
