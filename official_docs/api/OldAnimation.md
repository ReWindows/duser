...
**Category:** [Animation & PVL](./README.md)
...
|---|---|---|---|---|
| `GetInterface` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `Create` | `long` | `Method` | `Pdb` | No (PDB) |
| `RawActionProc` | `void` | `Method` | `Pdb` | No (PDB) |
| `OnComplete` | `void` | `Method` | `Pdb` | No (PDB) |
| `Destroy` | `void` | `Method` | `Pdb` | No (PDB) |
| `OnAsyncDestroy` | `void` | `Method` | `Pdb` | No (PDB) |
| `OnDestroyListener` | `void` | `Method` | `Pdb` | No (PDB) |
| `OnDestroySubject` | `void` | `Method` | `Pdb` | No (PDB) |
| `OnRemoveExisting` | `void` | `Method` | `Pdb` | No (PDB) |
| `SetCallback` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `SetFunction` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `SetTime` | `void` | `Accessor` | `Pdb` | No (PDB) |
