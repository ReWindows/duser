...
|---|---|---|---|---|
| `DecideGestureOrMouseSimulation` | `unsigned char` | `Method` | `Pdb` | No (PDB) |
| `OnCursorDown` | `unsigned char` | `Method` | `Pdb` | No (PDB) |
| `OnCursorUp` | `unsigned char` | `Method` | `Pdb` | No (PDB) |
| `OnPacket` | `unsigned char` | `Method` | `Pdb` | No (PDB) |
