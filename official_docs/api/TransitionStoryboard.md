...
| `ReleaseVisuals` | `void` | `Method` | `Pdb` | No (PDB) |
| `AddVisual` | `long` | `Method` | `Pdb` | No (PDB) |
| `Commit` | `void` | `Method` | `Pdb` | No (PDB) |
| `OnStoryboardStatusChanged` | `long` | `Method` | `Pdb` | No (PDB) |
| `OnStoryboardUpdated` | `long` | `Method` | `Pdb` | No (PDB) |
| `Build` | `long` | `Method` | `Pdb` | No (PDB) |
| `AddRef` | `unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `TransitionStoryboard` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~TransitionStoryboard` | `void` | `Dtor` | `Pdb` | No (PDB) |
