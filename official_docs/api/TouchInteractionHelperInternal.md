# `global` :: `TouchInteractionHelperInternal`
...
|---|---|---|---|---|
| `ProcessPointerInfo` | `bool` | `Method` | `Pdb` | No (PDB) |
| `GetInteractionInputFromPointerInfo` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `ProcessPointerMessage` | `void` | `Method` | `Pdb` | No (PDB) |
| `TouchInteractionHelperInternal` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~TouchInteractionHelperInternal` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `Destroy` | `void` | `Method` | `Pdb` | No (PDB) |
| `InitializeInteractionEngine` | `void` | `Method` | `Pdb` | No (PDB) |
| `InteractionEngineCallback` | `void` | `Method` | `Pdb` | No (PDB) |
| `ProcessInteractionInput` | `bool` | `Method` | `Pdb` | No (PDB) |
| `StaticInteractionEngineCallback` | `void` | `Method` | `Pdb` | No (PDB) |
| `TransformInteractionOutput` | `bool` | `Method` | `Pdb` | No (PDB) |
| `UpdateInteractionSettings` | `void` | `Method` | `Pdb` | No (PDB) |
