...
|---|---|---|---|---|
| `AddAction` | `class Action *` | `Method` | `Pdb` | No (PDB) |
| `xwProcessActionsNL` | `unsigned long` | `Method` | `Pdb` | No (PDB) |
| `xwRemoveAllActions` | `void` | `Method` | `Pdb` | No (PDB) |
| `~Scheduler` | `void` | `Dtor` | `Pdb` | No (PDB) |
