...
public:
    ...
    // Symbol: ??0Region@Gdiplus@@QEAA@XZ
    Region();
    // Category: Method | Source: PDB Internal
    // Symbol: ?Translate@Region@Gdiplus@@QEAA?AW4Status@2@HH@Z
...
|---|---|---|---|---|
| `Region` | `void` | `Ctor` | `Pdb` | No (PDB) |
| ``scalar deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| `Translate` | `enum Gdiplus::Status` | `Method` | `Pdb` | No (PDB) |
