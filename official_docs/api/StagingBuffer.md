...
| `EnsureSize` | `long` | `Method` | `Pdb` | No (PDB) |
| `BeginDraw` | `long` | `Method` | `Pdb` | No (PDB) |
| `DestroyGdiObjects` | `void` | `Method` | `Pdb` | No (PDB) |
| `DestroySurface` | `void` | `Method` | `Pdb` | No (PDB) |
| `OfferResources` | `void` | `Method` | `Pdb` | No (PDB) |
| `StagingBuffer` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `Cleanup` | `void` | `Method` | `Pdb` | No (PDB) |
