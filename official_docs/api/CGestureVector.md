# `global` :: `CGestureVector`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `duser.dll`. Total members: **10**.
...
|---|---|---|---|---|
| `AddPointToVector` | `void` | `Method` | `Pdb` | No (PDB) |
| `CGestureVector` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `CalculateDirection` | `unsigned int` | `Method` | `Pdb` | No (PDB) |
| `CalculateTotalAngle` | `double` | `Method` | `Pdb` | No (PDB) |
| `FitAngle` | `double` | `Method` | `Pdb` | No (PDB) |
| `IsLinear` | `int` | `Accessor` | `Pdb` | No (PDB) |
| `ReUseVector` | `void` | `Method` | `Pdb` | No (PDB) |
| `ResetVectorParameters` | `void` | `Method` | `Pdb` | No (PDB) |
| `UpdateSpeedWithDirection` | `void` | `Method` | `Pdb` | No (PDB) |
| `UpdateVectorSpeed` | `void` | `Method` | `Pdb` | No (PDB) |
