...
Reconstructed from `duser.dll`. Total members: **11**.
...
|---|---|---|---|---|
| `Graphics` | `void` | `Ctor` | `Pdb` | No (PDB) |
| ``scalar deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| `SetClip` | `enum Gdiplus::Status` | `Accessor` | `Pdb` | No (PDB) |
| `GetClip` | `enum Gdiplus::Status` | `Accessor` | `Pdb` | No (PDB) |
| `IsClipEmpty` | `int` | `Accessor` | `Pdb` | No (PDB) |
| `SetClip` | `enum Gdiplus::Status` | `Accessor` | `Pdb` | No (PDB) |
| `SetCompositingQuality` | `enum Gdiplus::Status` | `Accessor` | `Pdb` | No (PDB) |
| `SetPixelOffsetMode` | `enum Gdiplus::Status` | `Accessor` | `Pdb` | No (PDB) |
| `SetSmoothingMode` | `enum Gdiplus::Status` | `Accessor` | `Pdb` | No (PDB) |
| `SetTransform` | `enum Gdiplus::Status` | `Accessor` | `Pdb` | No (PDB) |
| `GetTransform` | `enum Gdiplus::Status` | `Accessor` | `Pdb` | No (PDB) |
