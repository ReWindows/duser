# `global` :: `ThumbFlickLogic`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `duser.dll`. Total members: **5**.
...
|---|---|---|---|---|
| `UpdateThumbDecision` | `void` | `Method` | `Pdb` | No (PDB) |
| `ComputeThumbFlickVelocity` | `struct MANIPULATION_VELOCITY` | `Method` | `Pdb` | No (PDB) |
| `IsThumbFlickDetected` | `bool` | `Accessor` | `Pdb` | No (PDB) |
| `SetAxis` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `UpdatePeakVelocity` | `void` | `Method` | `Pdb` | No (PDB) |
