...
|---|---|---|---|---|
| `CExternalSettings` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `GetParameter` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `SetParameter` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `SetPrivParameter` | `long` | `Accessor` | `Pdb` | No (PDB) |
