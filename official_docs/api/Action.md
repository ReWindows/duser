...
| `xwFireNL` | `void` | `Method` | `Pdb` | No (PDB) |
...
| `~Action` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `xwFireFinalNL` | `void` | `Method` | `Pdb` | No (PDB) |
| `Action` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `GetHandleType` | `enum HandleType` | `Accessor` | `Pdb` | No (PDB) |
| `EmptyActionProc` | `void` | `Method` | `Pdb` | No (PDB) |
