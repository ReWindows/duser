...
|---|---|---|---|---|
| `~DuAnimation` | `void` | `Dtor` | `Pdb` | No (PDB) |
...
| `ApiOnAsyncDestroy` | `long` | `Method` | `Pdb` | No (PDB) |
| `ApiOnDestroySubject` | `long` | `Method` | `Pdb` | No (PDB) |
| `ApiOnRemoveExisting` | `long` | `Method` | `Pdb` | No (PDB) |
| `ApiSetTime` | `long` | `Method` | `Pdb` | No (PDB) |
| `CleanupChangeGadget` | `void` | `Method` | `Pdb` | No (PDB) |
| `Destroy` | `void` | `Method` | `Pdb` | No (PDB) |
| `PostBuild` | `long` | `Method` | `Pdb` | No (PDB) |
