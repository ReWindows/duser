# `global` :: `CInteractionGroupingFilter`
...
|---|---|---|---|---|
| `Flush` | `void` | `Method` | `Pdb` | No (PDB) |
| `Input` | `void` | `Method` | `Pdb` | No (PDB) |
| `Stop` | `void` | `Method` | `Pdb` | No (PDB) |
| `_OnInput` | `void` | `Method` | `Pdb` | No (PDB) |
| `_SendOutput` | `void` | `Method` | `Pdb` | No (PDB) |
