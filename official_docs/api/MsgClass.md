...
|---|---|---|---|---|
| `~MsgClass` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `Build` | `long` | `Method` | `Pdb` | No (PDB) |
| `RegisterGuts` | `long` | `Method` | `Pdb` | No (PDB) |
| `FillStub` | `long` | `Method` | `Pdb` | No (PDB) |
| ``vector deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| ``scalar deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| `xwTearDownObject` | `void` | `Method` | `Pdb` | No (PDB) |
...
| `xwBuildObject` | `long` | `Method` | `Pdb` | No (PDB) |
| `xwBuildUpObject` | `long` | `Method` | `Pdb` | No (PDB) |
| `xwConstructCB` | `long` | `Method` | `Pdb` | No (PDB) |
