...
|---|---|---|---|---|
| `xwOnIdleNL` | `unsigned long` | `Method` | `Pdb` | No (PDB) |
...
| `~MotionSC` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `MotionSC` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `GetBrushF` | `class Gdiplus::Brush *` | `Accessor` | `Pdb` | No (PDB) |
| `GetPenF` | `class Gdiplus::Pen *` | `Accessor` | `Pdb` | No (PDB) |
