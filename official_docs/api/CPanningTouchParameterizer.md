# `global` :: `CPanningTouchParameterizer`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `duser.dll`. Total members: **3**.
...
|---|---|---|---|---|
| `SetMinimumVelocityFromRegistry` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `FitFrictionToCplCurve` | `double` | `Method` | `Pdb` | No (PDB) |
| `GetFrictionFactor` | `double` | `Accessor` | `Pdb` | No (PDB) |
