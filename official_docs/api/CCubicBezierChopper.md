# `CThemeAnimationScheduleHelper` :: `CCubicBezierChopper`
...
| `SetAbsoluteBeginTime` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `AddRef` | `unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `CCubicBezierChopper` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~CCubicBezierChopper` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `AddCubic` | `long` | `Method` | `Pdb` | No (PDB) |
| `AddRepeat` | `long` | `Method` | `Pdb` | No (PDB) |
| `AddSinusoidal` | `long` | `Method` | `Pdb` | No (PDB) |
| `AddTransitionToChoppedValue` | `long` | `Method` | `Pdb` | No (PDB) |
| `ContinueTo` | `long` | `Method` | `Pdb` | No (PDB) |
| `End` | `long` | `Method` | `Pdb` | No (PDB) |
| `IsWithinRange` | `bool` | `Accessor` | `Pdb` | No (PDB) |
