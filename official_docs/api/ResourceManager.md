...
Reconstructed from `duser.dll`. Total members: **13**.
...
|---|---|---|---|---|
| `UninitSharedThread` | `void` | `Method` | `Pdb` | No (PDB) |
| `xwNotifyThreadDestroyNL` | `void` | `Method` | `Pdb` | No (PDB) |
| `xwDoThreadDestroyNL` | `void` | `Method` | `Pdb` | No (PDB) |
| `UninitAllComponentsNL` | `void` | `Method` | `Pdb` | No (PDB) |
| `SharedThreadProc` | `unsigned int` | `Method` | `Pdb` | No (PDB) |
| `InitContextNL` | `long` | `Method` | `Pdb` | No (PDB) |
| `ResetSharedThread` | `void` | `Method` | `Pdb` | No (PDB) |
| `InitSharedThread` | `long` | `Method` | `Pdb` | No (PDB) |
| `Create` | `long` | `Method` | `Pdb` | No (PDB) |
| `xwDestroy` | `void` | `Method` | `Pdb` | No (PDB) |
| `SharedEventProc` | `long` | `Method` | `Pdb` | No (PDB) |
| `InitComponentNL` | `long` | `Method` | `Pdb` | No (PDB) |
| `RequestCreateCompatibleBitmap` | `struct HBITMAP__*` | `Method` | `Pdb` | No (PDB) |
