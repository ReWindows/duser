...
Reconstructed from `duser.dll`. Total members: **8**.
...
|---|---|---|---|---|
| `ComputeRgn` | `int` | `Method` | `Pdb` | No (PDB) |
| `Translate` | `void` | `Method` | `Pdb` | No (PDB) |
| `Matrix3` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `ComputeBounds` | `void` | `Method` | `Pdb` | No (PDB) |
| `Execute` | `void` | `Method` | `Pdb` | No (PDB) |
| `Scale` | `void` | `Method` | `Pdb` | No (PDB) |
| `Rotate` | `void` | `Method` | `Pdb` | No (PDB) |
| `ApplyRight` | `void` | `Method` | `Pdb` | No (PDB) |
