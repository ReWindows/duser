# `global` :: `CInertiaProcessor`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `duser.dll`. Total members: **6**.
...
|---|---|---|---|---|
| `GetInertiaEnd` | `int` | `Accessor` | `Pdb` | No (PDB) |
| `GetNextDisplacement` | `struct tagPOINT` | `Accessor` | `Pdb` | No (PDB) |
| `GetSpeed` | `struct MT::SPEED` | `Accessor` | `Pdb` | No (PDB) |
| `StartInertia` | `int` | `Method` | `Pdb` | No (PDB) |
| `_GetSpeed` | `struct MT::SPEED` | `Method` | `Pdb` | No (PDB) |
| `_InputTimeFromTimerTime` | `uint64_t` | `Method` | `Pdb` | No (PDB) |
