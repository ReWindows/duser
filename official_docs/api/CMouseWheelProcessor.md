# `global` :: `CMouseWheelProcessor`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `duser.dll`. Total members: **15**.
...
|---|---|---|---|---|
| `IsRunning` | `int` | `Accessor` | `Pdb` | No (PDB) |
| `GetInertiaDeceleration` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `GetInertiaEndTransform` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `GetResult` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `ProcessTime` | `long` | `Method` | `Pdb` | No (PDB) |
| `ProcessWheel` | `long` | `Method` | `Pdb` | No (PDB) |
| `SetCharTranslationX` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `SetCharTranslationY` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `SetDeltaRotation` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `SetDeltaScale` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `SetPageTranslationX` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `SetPageTranslationY` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `_GetRStart` | `double` | `Method` | `Pdb` | No (PDB) |
| `_GetWheelExpansion` | `long` | `Method` | `Pdb` | No (PDB) |
| `_GetWheelTranslation` | `long` | `Method` | `Pdb` | No (PDB) |
