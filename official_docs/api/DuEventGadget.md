# `global` :: `DuEventGadget`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `duser.dll`. Total members: **19**.
...
|---|---|---|---|---|
| `DuEventGadget` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~DuEventGadget` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `CleanupMessageHandlers` | `void` | `Method` | `Pdb` | No (PDB) |
| `ApiOnEvent` | `long` | `Method` | `Pdb` | No (PDB) |
| `AddMessageHandler` | `long` | `Method` | `Pdb` | No (PDB) |
| `DemoteEventGadget` | `struct HCLASS__*` | `Method` | `Pdb` | No (PDB) |
| `PromoteEventGadget` | `long` | `Method` | `Pdb` | No (PDB) |
...
| `AddMessageHandler` | `long` | `Method` | `Pdb` | No (PDB) |
| `ApiAddHandlerD` | `long` | `Method` | `Pdb` | No (PDB) |
| `ApiAddHandlerG` | `long` | `Method` | `Pdb` | No (PDB) |
| `ApiGetFilter` | `long` | `Method` | `Pdb` | No (PDB) |
| `ApiRemoveHandlerD` | `long` | `Method` | `Pdb` | No (PDB) |
| `ApiRemoveHandlerG` | `long` | `Method` | `Pdb` | No (PDB) |
| `ApiSetFilter` | `long` | `Method` | `Pdb` | No (PDB) |
| `RemoveMessageHandler` | `long` | `Method` | `Pdb` | No (PDB) |
