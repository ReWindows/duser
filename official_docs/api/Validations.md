...
|---|---|---|---|---|
| `IsNaN` | `bool` | `Accessor` | `Pdb` | No (PDB) |
| `IsNaN` | `bool` | `Accessor` | `Pdb` | No (PDB) |
| `CheckFinite` | `void` | `Method` | `Pdb` | No (PDB) |
| `CheckFiniteNonNegative` | `void` | `Method` | `Pdb` | No (PDB) |
| `CheckFiniteOrNaN` | `void` | `Method` | `Pdb` | No (PDB) |
| `IsInfinity` | `bool` | `Accessor` | `Pdb` | No (PDB) |
