# `global` :: `CTouchGestureMachine`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `duser.dll`. Total members: **24**.
...
|---|---|---|---|---|
| `OnCursorDown` | `void` | `Method` | `Pdb` | No (PDB) |
| `EnsureTouchComponents` | `long` | `Method` | `Pdb` | No (PDB) |
| `CTouchGestureMachine` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~CTouchGestureMachine` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `DispatchGesture` | `void` | `Method` | `Pdb` | No (PDB) |
| `DispatchInertia` | `int` | `Method` | `Pdb` | No (PDB) |
| `FinishGestureStream` | `void` | `Method` | `Pdb` | No (PDB) |
| `GenerateInertia` | `int` | `Method` | `Pdb` | No (PDB) |
| `GenerateManipulationInertia` | `int` | `Method` | `Pdb` | No (PDB) |
| `GetCrossSlideParameter` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `HandleEndOfGesture` | `void` | `Method` | `Pdb` | No (PDB) |
| `HandleInertiaForQuickPan` | `void` | `Method` | `Pdb` | No (PDB) |
| `InGestureMode` | `int` | `Method` | `Pdb` | No (PDB) |
| `OnCursorUp` | `void` | `Method` | `Pdb` | No (PDB) |
| `OnPacket` | `void` | `Method` | `Pdb` | No (PDB) |
| `OnStop` | `void` | `Method` | `Pdb` | No (PDB) |
| `RegisterInertiaSetupCallback` | `long` | `Method` | `Pdb` | No (PDB) |
| `ResetTouchGestureMachine` | `void` | `Method` | `Pdb` | No (PDB) |
| `SetCrossSlideParameters` | `long` | `Accessor` | `Pdb` | No (PDB) |
...
| `StartGestureStream` | `void` | `Method` | `Pdb` | No (PDB) |
| `_AddGestureOutput` | `void` | `Method` | `Pdb` | No (PDB) |
