...
|---|---|---|---|---|
| `CFlickMachine` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~CFlickMachine` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `CanBeFlick` | `int` | `Method` | `Pdb` | No (PDB) |
| `Initialize` | `long` | `Method` | `Pdb` | No (PDB) |
| `OnCursorDown` | `void` | `Method` | `Pdb` | No (PDB) |
| `PostCurrentResult` | `long` | `Method` | `Pdb` | No (PDB) |
