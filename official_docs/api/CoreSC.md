...
Reconstructed from `duser.dll`. Total members: **18**.
...
|---|---|---|---|---|
| `xwProcessMsgQNL` | `void` | `Method` | `Pdb` | No (PDB) |
| `MarkDataNL` | `void` | `Method` | `Pdb` | No (PDB) |
| `PostNL` | `long` | `Method` | `Pdb` | No (PDB) |
| `xwProcessNL` | `void` | `Method` | `Pdb` | No (PDB) |
| `xwProcessNL` | `void` | `Method` | `Pdb` | No (PDB) |
| `DUIMsgWaitForMultipleObjectsEx` | `unsigned long` | `Method` | `Pdb` | No (PDB) |
| `xwProcessNL` | `int` | `Method` | `Pdb` | No (PDB) |
| `Create` | `long` | `Method` | `Pdb` | No (PDB) |
| `WaitMessage` | `void` | `Method` | `Pdb` | No (PDB) |
| ``vector deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| ``scalar deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| `~CoreSC` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `xwPreDestroyNL` | `void` | `Method` | `Pdb` | No (PDB) |
| `GetDragPointer` | `struct tagPointerTrack *` | `Accessor` | `Pdb` | No (PDB) |
| `ClearDragPointer` | `void` | `Method` | `Pdb` | No (PDB) |
| `SetDragPointer` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `xwFireMessagesNL` | `long` | `Method` | `Pdb` | No (PDB) |
| `xwSendNL` | `long` | `Method` | `Pdb` | No (PDB) |
