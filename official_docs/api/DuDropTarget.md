...
Reconstructed from `duser.dll`. Total members: **16**.
...
| `DemoteDropTarget` | `struct HCLASS__*` | `Method` | `Pdb` | No (PDB) |
| `xwDragLeave` | `void` | `Method` | `Pdb` | No (PDB) |
| `DuDropTarget` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~DuDropTarget` | `void` | `Dtor` | `Pdb` | No (PDB) |
| ``vector deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| ``scalar deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| `ApiOnDestroySubject` | `long` | `Method` | `Pdb` | No (PDB) |
| `DragEnter` | `long` | `Method` | `Pdb` | No (PDB) |
| `DragLeave` | `long` | `Method` | `Pdb` | No (PDB) |
| `DragOver` | `long` | `Method` | `Pdb` | No (PDB) |
| `Drop` | `long` | `Method` | `Pdb` | No (PDB) |
| `PromoteDropTarget` | `long` | `Method` | `Pdb` | No (PDB) |
| `xwDragScan` | `long` | `Method` | `Pdb` | No (PDB) |
| `xwUpdateTarget` | `long` | `Method` | `Pdb` | No (PDB) |
| `xwUpdateTarget` | `long` | `Method` | `Pdb` | No (PDB) |
