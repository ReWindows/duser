# `global` :: `CGestureConfigurator`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `duser.dll`. Total members: **7**.
...
|---|---|---|---|---|
| `GestureConfigAtTouchDown` | `void` | `Method` | `Pdb` | No (PDB) |
| `ConfigureMultiTouchGestureLogic` | `void` | `Method` | `Pdb` | No (PDB) |
| `ConfigureGestureModifierEngine` | `void` | `Method` | `Pdb` | No (PDB) |
| `DecideDragOrScrollBasedOnDirection` | `void` | `Method` | `Pdb` | No (PDB) |
| `GestureConfigAtTouchMove` | `void` | `Method` | `Pdb` | No (PDB) |
| `GestureConfigAtTouchUp` | `void` | `Method` | `Pdb` | No (PDB) |
| `ProcessGestureConfig` | `void` | `Method` | `Pdb` | No (PDB) |
