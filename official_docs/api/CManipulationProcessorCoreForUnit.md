# `global` :: `CManipulationProcessorCoreForUnit`
...
|---|---|---|---|---|
| `CManipulationProcessorCoreForUnit` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `_ResetState` | `void` | `Method` | `Pdb` | No (PDB) |
| ``vector deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| ``scalar deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| `GetManipulationVelocity` | `struct MANIPULATION_VELOCITY` | `Accessor` | `Pdb` | No (PDB) |
| `GetRailsState` | `enum MANIPULATION_RAILS_STATE` | `Accessor` | `Pdb` | No (PDB) |
