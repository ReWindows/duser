...
|---|---|---|---|---|
| `ReleaseRegion` | `long` | `Method` | `Pdb` | No (PDB) |
| `AcquireRegion` | `long` | `Method` | `Pdb` | No (PDB) |
| `DeleteRegionSurface` | `long` | `Method` | `Pdb` | No (PDB) |
| `Commit` | `long` | `Method` | `Pdb` | No (PDB) |
| `AtlasingManager` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `StoreAtlasHint` | `void` | `Method` | `Pdb` | No (PDB) |
