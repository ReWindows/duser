...
|---|---|---|---|---|
| `CDebugHelp` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~CDebugHelp` | `void` | `Dtor` | `Pdb` | No (PDB) |
| ``vector deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| ``scalar deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| `AssertFailedLine` | `int` | `Method` | `Pdb` | No (PDB) |
| `Prompt` | `int` | `Method` | `Pdb` | No (PDB) |
| `IsValidAddress` | `int` | `Accessor` | `Pdb` | No (PDB) |
