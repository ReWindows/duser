...
|---|---|---|---|---|
| `BuildClass` | `long` | `Method` | `Pdb` | No (PDB) |
| `FindClass` | `class MsgClass const *` | `Method` | `Pdb` | No (PDB) |
| `~ClassLibrary` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `RegisterSuperNL` | `long` | `Method` | `Pdb` | No (PDB) |
| `MarkInternal` | `void` | `Method` | `Pdb` | No (PDB) |
