...
|---|---|---|---|---|
| `DimensionFromParameter` | `int` | `Method` | `Pdb` | No (PDB) |
| `CInertiaParameter` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `GetState` | `enum CInertiaParameter::State` | `Accessor` | `Pdb` | No (PDB) |
| `IsParameterDeceleration` | `int` | `Accessor` | `Pdb` | No (PDB) |
