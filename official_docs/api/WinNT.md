...
Reconstructed from `duser.dll`. Total members: **27**.
...
|---|---|---|---|---|
| `PushXForm` | `void` | `Method` | `Pdb` | No (PDB) |
| `PopXForm` | `void` | `Method` | `Pdb` | No (PDB) |
| `SetWorldTransform` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `SetIdentityTransform` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `IsInsideLoaderLock` | `int` | `Accessor` | `Pdb` | No (PDB) |
| `RegisterTouchHitTestingWindow` | `int` | `Method` | `Pdb` | No (PDB) |
| `EvaluateProximityToRect` | `int` | `Method` | `Pdb` | No (PDB) |
| ``vector deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| ``scalar deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| `PackTouchHitTestingProximityEvaluation` | `int64_t` | `Method` | `Pdb` | No (PDB) |
| `CreateFontIndirectA` | `struct HFONT__*` | `Method` | `Pdb` | No (PDB) |
| `DrawTextA` | `int` | `Method` | `Pdb` | No (PDB) |
| `ExtTextOutA` | `int` | `Method` | `Pdb` | No (PDB) |
| `GetHimetricScaleFactorFromPixelLocation` | `int` | `Accessor` | `Pdb` | No (PDB) |
| `GetPointerDevice` | `int` | `Accessor` | `Pdb` | No (PDB) |
| `GetPointerDeviceRects` | `int` | `Accessor` | `Pdb` | No (PDB) |
| `GetPointerFrameInfoHistory` | `int` | `Accessor` | `Pdb` | No (PDB) |
| `GetPointerInfo` | `int` | `Accessor` | `Pdb` | No (PDB) |
| `GetPointerTouchInfo` | `int` | `Accessor` | `Pdb` | No (PDB) |
| `GetTextExtentExPointA` | `int` | `Accessor` | `Pdb` | No (PDB) |
| `GetTextExtentPoint32A` | `int` | `Accessor` | `Pdb` | No (PDB) |
| `LogicalToPhysicalPoint` | `int` | `Method` | `Pdb` | No (PDB) |
| `PhysicalToLogicalPoint` | `int` | `Method` | `Pdb` | No (PDB) |
| `RotateDC` | `void` | `Method` | `Pdb` | No (PDB) |
| `ScaleDC` | `void` | `Method` | `Pdb` | No (PDB) |
| `TextOutA` | `int` | `Method` | `Pdb` | No (PDB) |
| `TranslateDC` | `void` | `Method` | `Pdb` | No (PDB) |
