//! Windissect-generated Rust FFI bindings for duser.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "84CB1D82FC5C10EC36D3A0C3457E64E8";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 4240265679;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 10] = [100, 117, 115, 101, 114, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 4240265679 { return 0; }
