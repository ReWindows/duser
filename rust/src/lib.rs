...
pub const EXPECTED_PDB_GUID: &str = "181E01F67ED6ADA472C99FA5EE42B487";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 2638932190;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 10] = [68, 85, 115, 101, 114, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 2638932190 { return 0; }
